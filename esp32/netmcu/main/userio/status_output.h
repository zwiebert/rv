...
typedef enum {
  ...
  SO_SEP_ENABLE, SO_SEP_DISABLE, SO_SEP_BUTTON_PRESSED_ERROR, //4

  SO_CUAS_START, SO_CUAS_TIMEOUT, SO_CUAS_DONE, //7

  SO_PRAS_START_LISTENING, SO_PRAS_STOP_LISTENING, SO_PRAS_TIMEOUT, SO_PRAS_DONE, //11

  SO_CFG_all, SO_CFG_begin, //13
  SO_CFG_CU, SO_CFG_BAUD, SO_CFG_RTC, SO_CFG_WLAN_SSID, SO_CFG_WLAN_PASSWORD, SO_CFG_NTP_SERVER, //19
  SO_CFG_LONGITUDE, SO_CFG_LATITUDE,  SO_CFG_TIMEZONE, SO_CFG_DST, SO_CFG_TZ, SO_CFG_VERBOSE, //25
  ...
  SO_MCU_begin, SO_MCU_BOOT_COUNT, SO_MCU_end,
