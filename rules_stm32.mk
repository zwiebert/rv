# rules related to stm32/rv
#
.PHONY: fetch_libopencm3 build_libopencm3

# Make targets to forward to stm32/rv
#
...
# somre rules about fetching and building libopencm3 
# the Makefine in the sub-directory may handle this by itself
# 
