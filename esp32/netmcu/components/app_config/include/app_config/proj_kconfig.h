...
#ifdef CONFIG_RV_USE_HTTP
#define USE_HTTP
#else
#define NO_HTTP
#endif

#ifdef CONFIG_RV_USE_LAN
#define USE_LAN
#else
#define NO_LAN
#endif

#ifdef CONFIG_RV_USE_WLAN
#define USE_WLAN
#else
#define NO_WLAN
#endif

#ifdef CONFIG_RV_USE_WLAN_AP
#define USE_WLAN_AP
#else
#define NO_WLAN_AP
#endif

#ifdef CONFIG_RV_USE_NTP
#define USE_NTP
#else
#define NO_NTP
#endif
...
#ifdef CONFIG_RV_USE_MQTT
#define USE_MQTT
#else
#define NO_MQTT
#endif

#ifdef CONFIG_RV_USE_POSIX_TIME
#define USE_POSIX_TIME
#else
#define NO_POSIX_TIME
#endif

#ifdef CONFIG_RV_USE_SERIAL
#define USE_SERIAL
#else
#define NO_SERIAL
#endif

#ifdef CONFIG_RV_USE_WDG
#define USE_WDG
#else
#define NO_WDG
#endif

#ifdef CONFIG_RV_USE_FS
#define USE_FS
#else
#define NO_FS
#endif

#ifdef CONFIG_RV_USE_HTTP_CLIENT
#define USE_HTTP_CLIENT
#else
#define NO_HTTP_CLIENT
#endif

#ifdef CONFIG_RV_USE_OTA
#define USE_OTA
#else
#define NO_OTA
#endif

#ifdef CONFIG_RV_USE_STM32OTA
#define USE_STM32OTA
#else
#define NO_STM32OTA
#endif

#ifdef CONFIG_RV_USE_TCPS_TASK
#define USE_TCPS_TASK
#else
#define NO_TCPS_TASK
#endif

#ifdef CONFIG_RV_USE_TCPS
#define USE_TCPS
#else
#define NO_TCPS
#endif

#ifdef CONFIG_RV_USE_EG
#define USE_EG
#else
#define NO_EG
#endif

#ifdef CONFIG_RV_USE_LPH
#define USE_LPH
#else
#define NO_LPH
#endif

#ifdef CONFIG_RV_USE_WS
#define USE_WS
#else
#define NO_WS
#endif

#ifdef CONFIG_RV_USE_CLI_MUTEX
#define USE_CLI_MUTEX
#else
#define NO_CLI_MUTEX
#endif

#ifdef CONFIG_RV_USE_NETWORK
#define USE_NETWORK
#else
#define NO_NETWORK
#endif

#ifdef CONFIG_RV_USE_STM32COM
#define USE_STM32COM
#else
#define NO_STM32COM
#endif

#ifdef CONFIG_RV_USE_AP_FALLBACK
