...
$ocd_cmd \
        ...
        -c "program_esp  $BINDIR/ota_data_initial.bin $part_ota_init  verify" \
        -c "program_esp  $BINDIR/netmcu.bin   $part_ota0 verify reset exit"
}


flash_app() {
$ocd_cmd \
        -c "program_esp  $BINDIR/netmcu.bin  $part_ota0 reset exit"
}
